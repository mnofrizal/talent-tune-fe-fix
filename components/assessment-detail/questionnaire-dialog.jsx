...
import { CategorySection } from "./questionnaire/category-section";
import { questions } from "./questionnaire/questions-data";

export function QuestionnaireDialog({ open, onOpenChange, onComplete }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[95vh] max-w-4xl p-0">
        <div className="sticky top-0 border-b px-6 pb-4 pt-6">
          <DialogHeader>
